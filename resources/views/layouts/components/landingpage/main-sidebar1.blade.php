                    ...
                    <div class="horizontal-logo">
                        ...
                        <ul class="main-menu flex-fill justify-content-center">
                            ...
                            <li class="slide">
                                <a href="#get-started" class="side-menu__item">
                                    <span class="side-menu__label">Get Started</span>
                                </a>
                            </li>
                            <!-- End::slide -->
                        </ul>
                        ...
                        <div class="d-lg-flex d-none align-items-center">
                            <div class="btn-list d-xl-flex d-none">
                                @auth
                                    <a href="{{ route('index') }}" class="btn btn-wave btn-primary border">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}" class="btn btn-wave btn-primary border">Login / Register</a>
                                @endauth
                            </div>
                        </div>    
                    </nav>
