@php
    $filtersView = view('reports.partials.disposal_filters', compact('filters','assets'));
@endphp

@extends('reports.layout', ['title' => 'Laporan Disposal', 'subtitle' => 'Filter per tanggal, status reverse', 'filtersView' => $filtersView])
